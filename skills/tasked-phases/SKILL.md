...
6. When work is completed, update checklist state with `set_task_checked`.
7. If the plan changes materially, update the stored state instead of only describing the new plan in prose.
